    <section id="about">
        <div class="about container d-flex gap-5 flex-column flex-lg-row position-relative">
            <div class="imagex d-flex gap-5 flex-column position-relative d-none d-lg-block">
                <img src="assets/technical(1).jpeg" alt="">
                <img src="assets/technical(2).jpeg" alt="">
            </div>

            <div class="words d-flex flex-column gap-3">
                <p class="fw-semibold my-0">TECHNICAL SUPPORT</p>
                <p class="display-6 fw-bolder my-0"><span style="color: var(--color-primary);">Reliable technical</span>
                    support anytime assistance</p>
                <p style="color: var(--color-dark);">Our dedicated technical support team is available around the clock
